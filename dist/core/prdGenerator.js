...
function generateScreenPurpose(screenName) {
    ...
    if (nameLower.includes('login'))
        return 'User authentication page with login form';
    if (nameLower.includes('patient')) {
        if (nameLower.includes('detail'))
            return 'Detailed view of individual patient information, demographics, and medical history';
        if (nameLower.includes('document'))
            return 'Page for viewing, uploading, and managing patient documents and medical records';
        if (nameLower.includes('record'))
            return 'Comprehensive view of patient medical records, history, and treatment notes';
        if (nameLower.includes('portal'))
            return 'Main patient portal dashboard with access to records, appointments, and messages';
        if (nameLower.includes('profile'))
            return 'Patient profile page for viewing and editing personal information';
    ...
    if (nameLower.includes('report'))
        return 'Page for generating and viewing various reports and analytics';
