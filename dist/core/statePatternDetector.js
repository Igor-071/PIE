 ...
 */
export async function detectStatePatterns(repoPath, allFiles) {
    const patterns = [];
    const seenPatterns = new Set();
    // Find potential state management files
    const stateFiles = allFiles.filter((f) => (f.endsWith(".ts") ||
        f.endsWith(".tsx") ||
        f.endsWith(".js") ||
        f.endsWith(".jsx")) &&
 ...
 */
function detectRedux(content, filePath) {
    const patterns = [];
 ...
 */
function detectZustand(content, filePath) {
    const patterns = [];
 ...
 */
function detectReactContext(content, filePath) {
    const patterns = [];
 ...
 */
function detectReactQuery(content, filePath) {
    const patterns = [];
 ...
 */
function detectRecoil(content, filePath) {
    const patterns = [];
 ...
 */
function detectMobX(content, filePath) {
    const patterns = [];
    ...
    if (content.includes("makeObservable") ||
...
//# sourceMappingURL=statePatternDetector.js.map