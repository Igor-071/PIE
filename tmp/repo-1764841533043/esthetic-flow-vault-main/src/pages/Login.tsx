...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-surface-soft/50 to-primary/5 p-4 relative overflow-hidden">
      ...
      <Card variant="glass" className="w-full max-w-md shadow-[var(--shadow-luxury)] border-[var(--glass-border)] backdrop-blur-xl relative z-10">
        <CardHeader className="space-y-4 text-center pb-6">
          ...
          <div className="mx-auto w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/10 flex items-center justify-center mb-2 shadow-[var(--shadow-elevated)]">
            <Syringe className="w-10 h-10 text-primary" />
          </div>
          <CardTitle className="text-3xl font-serif font-semibold">Clinic Portal</CardTitle>
          <CardDescription className="text-base">
            Provider & staff access for practice management
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Privacy-first records management
          </p>
        </CardContent>
      </Card>
    </div>
